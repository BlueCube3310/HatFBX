...
bl_info = {
    "name": "FBX format (A Hat in Time Editor)",
    "author": "Campbell Barton, Bastien Montagne, Jens Restemeier, @Mysteryem, Blue Cube",
    "version": (5, 4, 0),
    "blender": (3, 6, 0),
...
class AHITImportFBX(bpy.types.Operator, ImportHelper):
    """Load a FBX file"""
    bl_idname = "import_scene.fbxahit"
    bl_label = "Import FBX"
...
class AHITFBX_PT_import_include(bpy.types.Panel):
    ...
    def poll(cls, context):
        ...
        return operator.bl_idname == "IMPORT_SCENE_OT_fbxahit"
...
class AHITFBX_PT_import_transform(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Transform"
    bl_parent_id = "FILE_PT_operator"
...
class AHITFBX_PT_import_transform_manual_orientation(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Manual Orientation"
    bl_parent_id = "AHITFBX_PT_import_transform"
...
class AHITFBX_PT_import_animation(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Animation"
    bl_parent_id = "FILE_PT_operator"
...
class AHITFBX_PT_import_armature(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Armature"
    bl_parent_id = "FILE_PT_operator"
...
@orientation_helper(axis_forward='-Z', axis_up='Y')
class AHITExportFBX(bpy.types.Operator, ExportHelper):
    """Write a FBX file"""
    bl_idname = "export_scene.fbxahit"
    bl_label = "Export FBX"
    bl_options = {'UNDO', 'PRESET'}
...
class AHITFBX_PT_export_main(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = ""
    bl_parent_id = "FILE_PT_operator"
    ...
    def poll(cls, context):
        ...
        return operator.bl_idname == "EXPORT_SCENE_OT_fbxahit"
...
class AHITFBX_PT_export_include(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Include"
    bl_parent_id = "FILE_PT_operator"
...
class AHITFBX_PT_export_transform(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Transform"
    bl_parent_id = "FILE_PT_operator"
...
class AHITFBX_PT_export_geometry(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Geometry"
    bl_parent_id = "FILE_PT_operator"
...
class AHITFBX_PT_export_armature(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Armature"
    bl_parent_id = "FILE_PT_operator"
...
class AHITFBX_PT_export_bake_animation(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
...
def menu_func_import(self, context):
    self.layout.operator(AHITImportFBX.bl_idname, text="AHIT FBX (.fbx)")


def menu_func_export(self, context):
    self.layout.operator(AHITExportFBX.bl_idname, text="AHIT FBX (.fbx)")


classes = (
    AHITImportFBX,
    AHITFBX_PT_import_include,
    AHITFBX_PT_import_transform,
    AHITFBX_PT_import_transform_manual_orientation,
    AHITFBX_PT_import_animation,
    AHITFBX_PT_import_armature,
    AHITExportFBX,
    AHITFBX_PT_export_main,
    AHITFBX_PT_export_include,
    AHITFBX_PT_export_transform,
    AHITFBX_PT_export_geometry,
    AHITFBX_PT_export_armature,
    AHITFBX_PT_export_bake_animation,
)
