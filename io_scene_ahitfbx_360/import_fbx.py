...
class FbxImportHelperNode:
    ...
    def find_armatures(self):
        ...
        if len(self.children) == 0 and self.is_bone:
            needs_armature = True
...
def load(operator, context, filepath="",
    ...
    def _():
        ...
        for a_uuid, a_item in fbx_table_nodes.items():
            ...
            is_bone = fbx_obj.props[2] in {b'LimbNode', b'Limb', b'Root'}
    ...
    if use_anim:
        ...
        def _():
            ...
            blen_read_animations(fbx_tmpl_astack, fbx_tmpl_alayer, stacks, scene, settings.anim_offset, settings.global_scale)
